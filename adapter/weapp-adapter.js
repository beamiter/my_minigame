	...
	function inject() {
	  ...
	  if (platform === 'devtools') {
	    ...
	    for (var _key in _window.document) {
	      ...
	      // 兼容引擎IDE本地的能力 如果本地web提供了 就不去替换
	      if (typeof global.document[_key] !== 'undefined' && global.document[_key] !== null) {
	        continue;
	      }
