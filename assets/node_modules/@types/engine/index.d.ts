...
declare module '!!Only Export Engine Module, Cant Use Internal Module：engine/assets/classes/effect' {
	...
	import { EffectAsset } from '!!Only Export Engine Module, Cant Use Internal Module：engine/assets/resource';
	import BaseResource from '!!Only Export Engine Module, Cant Use Internal Module：engine/assets/classes/baseResource';
	import { Kanata } from '!!Only Export Engine Module, Cant Use Internal Module：engine/globalContext';
	export function CONVERT_COMPARE_FUNC(old: number): Kanata.ECompareFunc.LESS | Kanata.ECompareFunc.LEQUAL | Kanata.ECompareFunc.EQUAL | Kanata.ECompareFunc.GREATER | Kanata.ECompareFunc.NOTEQUAL | Kanata.ECompareFunc.NEVER | Kanata.ECompareFunc.ALWAYS;
	export function CONVERT_STENCIL_OP(old: number): Kanata.EStencilOp.ZERO | Kanata.EStencilOp.KEEP | Kanata.EStencilOp.REPLACE | Kanata.EStencilOp.INCR | Kanata.EStencilOp.DECR_WRAP | Kanata.EStencilOp.DECR | Kanata.EStencilOp.INVERT;
	export function CONVERT_BLEND_FACTOR(old: number): Kanata.EBlendFactor.ZERO | Kanata.EBlendFactor.ONE | Kanata.EBlendFactor.SRC_COLOR | Kanata.EBlendFactor.ONE_MINUS_SRC_COLOR | Kanata.EBlendFactor.SRC_ALPHA | Kanata.EBlendFactor.ONE_MINUS_SRC_ALPHA | Kanata.EBlendFactor.DST_ALPHA | Kanata.EBlendFactor.ONE_MINUS_DST_ALPHA | Kanata.EBlendFactor.DST_COLOR | Kanata.EBlendFactor.ONE_MINUS_DST_COLOR | Kanata.EBlendFactor.SRC_ALPHA_SATURATE;
	export function CONVERT_BLEND_EQUATION(old: number): Kanata.EBlendEquation.FUNC_ADD | Kanata.EBlendEquation.FUNC_SUBTRACT | Kanata.EBlendEquation.FUNC_REVERSE_SUBTRACT;
	export function CONVERT_PRIMITIVE_TYPE(old: number): Kanata.EPrimitiveType.TRIANGLES | Kanata.EPrimitiveType.TRIANGLE_STRIP | Kanata.EPrimitiveType.LINES | Kanata.EPrimitiveType.LINE_STRIP | Kanata.EPrimitiveType.POINTS;
	export function CONVERT_CULL_MODE(old: number): number;
	...
	*/
	export function CONVERT_UNIFORM_TYPE(type: number): Kanata.EUniformType.FLOAT | Kanata.EUniformType.FLOAT2 | Kanata.EUniformType.FLOAT3 | Kanata.EUniformType.FLOAT4 | Kanata.EUniformType.MAT4;
	/**
	 * 特效资源，供Material使用。
	 */
...
declare module '!!Only Export Engine Module, Cant Use Internal Module：engine/assets/classes/material' {
	import { Nullable } from '!!Only Export Engine Module, Cant Use Internal Module：engine/type';
	import { IMaterialRenderStates } from '!!Only Export Engine Module, Cant Use Internal Module：engine/assets/resource';
	import BaseResource from '!!Only Export Engine Module, Cant Use Internal Module：engine/assets/classes/baseResource';
	...
	import Vector4 from '!!Only Export Engine Module, Cant Use Internal Module：engine/math/vector4';
	import { Kanata } from '!!Only Export Engine Module, Cant Use Internal Module：engine/globalContext';
	export const MaterialResourceShaderDefinationKeys: string[];
	/**
	 * 材质资源。
	 */
	export default class Material extends BaseResource {
	    ...
	    set renderStates(states: IMaterialRenderStates);
	    /**
...
declare module '!!Only Export Engine Module, Cant Use Internal Module：engine/game/particles/libs/arcShape' {
	import { IParticleEmitterShapeOffsetMap } from '!!Only Export Engine Module, Cant Use Internal Module：engine/game/particles/interface';
	import { ArcMode, ParticleShape } from '!!Only Export Engine Module, Cant Use Internal Module：engine/game/particles/libs/shape'; type Particle = import('!!Only Export Engine Module, Cant Use Internal Module：engine/game/particles/particle').default;
...
declare module '!!Only Export Engine Module, Cant Use Internal Module：engine/game/particles/libs/circleShape' {
	...
	import { ArcMode as ArcModeEnum } from '!!Only Export Engine Module, Cant Use Internal Module：engine/game/particles/libs/shape'; type Particle = import('!!Only Export Engine Module, Cant Use Internal Module：engine/game/particles/particle').default; class ParticleCircleShape extends ParticleArcShape {
	    constructor(particle: Particle, offsetMap: IParticleEmitterShapeOffsetMap);
...
declare module '!!Only Export Engine Module, Cant Use Internal Module：engine/game/particles/libs/coneShape' {
	import { IParticleEmitterShapeOffsetMap } from '!!Only Export Engine Module, Cant Use Internal Module：engine/game/particles/interface';
	import ParticleArcShape from '!!Only Export Engine Module, Cant Use Internal Module：engine/game/particles/libs/arcShape'; type Particle = import('!!Only Export Engine Module, Cant Use Internal Module：engine/game/particles/particle').default; enum EEmitFromCone {
	    Base = 1,
	    Volume = 2
...
declare module '!!Only Export Engine Module, Cant Use Internal Module：engine/game/particles/libs/hemiSphereShape' {
	import { IParticleEmitterShapeOffsetMap } from '!!Only Export Engine Module, Cant Use Internal Module：engine/game/particles/interface';
	import ParticleArcShape from '!!Only Export Engine Module, Cant Use Internal Module：engine/game/particles/libs/arcShape';
	import { ArcMode as ArcModeEnum } from '!!Only Export Engine Module, Cant Use Internal Module：engine/game/particles/libs/shape'; type Particle = import('!!Only Export Engine Module, Cant Use Internal Module：engine/game/particles/particle').default; class ParticleHemiSphereShape extends ParticleArcShape {
	    constructor(particle: Particle, offsetMap: IParticleEmitterShapeOffsetMap);
...
declare module '!!Only Export Engine Module, Cant Use Internal Module：engine/game/particles/libs/sphereShape' {
	import { IParticleEmitterShapeOffsetMap } from '!!Only Export Engine Module, Cant Use Internal Module：engine/game/particles/interface';
	import ParticleArcShape from '!!Only Export Engine Module, Cant Use Internal Module：engine/game/particles/libs/arcShape';
	import { ArcMode as ArcModeEnum } from '!!Only Export Engine Module, Cant Use Internal Module：engine/game/particles/libs/shape'; type Particle = import('!!Only Export Engine Module, Cant Use Internal Module：engine/game/particles/particle').default; class ParticleSphereShape extends ParticleArcShape {
	    constructor(particle: Particle, offsetMap: IParticleEmitterShapeOffsetMap);
...
declare module '!!Only Export Engine Module, Cant Use Internal Module：engine/game/particles/bufferManager' {
	...
	import Vector3 from '!!Only Export Engine Module, Cant Use Internal Module：engine/math/vector3';
	import Vector4 from '!!Only Export Engine Module, Cant Use Internal Module：engine/math/vector4';
	import { AdvancedProperty, ColorAdvancedProperty, IParticleModulesOffsetMapAll, IParticleModulesOffsetMapOne, IVectorPropertyOffsetMap } from '!!Only Export Engine Module, Cant Use Internal Module：engine/game/particles/interface';
	...
	export function getAdvancedProperty(defaultBuffer: Float32Array, offsetMap: IParticleModulesOffsetMapOne, key: keyof IParticleModulesOffsetMapAll): AdvancedPropertyClass.ConstantProperty | AdvancedPropertyClass.CurveProperty | AdvancedPropertyClass.TwoConstantsProperty | AdvancedPropertyClass.TwoCurvesProperty | undefined;
	export function setAdvancedProperty(defaultBuffer: Float32Array, offsetMap: IParticleModulesOffsetMapOne, key: keyof IParticleModulesOffsetMapAll, val: AdvancedPropertyClass.ConstantProperty | AdvancedPropertyClass.CurveProperty | AdvancedPropertyClass.TwoConstantsProperty | AdvancedPropertyClass.TwoCurvesProperty | undefined): void;
	export function getColorAdvancedProperty(defaultBuffer: Float32Array, offsetMap: IParticleModulesOffsetMapOne, key: keyof IParticleModulesOffsetMapAll): AdvancedPropertyClass.OneColorProperty | AdvancedPropertyClass.TwoColorsProperty | AdvancedPropertyClass.GradientProperty | AdvancedPropertyClass.TwoGradientsProperty | undefined;
	export function setColorAdvancedProperty(defaultBuffer: Float32Array, offsetMap: IParticleModulesOffsetMapOne, key: keyof IParticleModulesOffsetMapAll, val: AdvancedPropertyClass.OneColorProperty | AdvancedPropertyClass.TwoColorsProperty | AdvancedPropertyClass.GradientProperty | AdvancedPropertyClass.TwoGradientsProperty | undefined): void;
...
declare module '!!Only Export Engine Module, Cant Use Internal Module：engine/game/particles/libs/emitterBurst' {
	import { IParticleEmitterBurstsOffsetMap } from '!!Only Export Engine Module, Cant Use Internal Module：engine/game/particles/interface';
	import AdvancedPropertyClass from '!!Only Export Engine Module, Cant Use Internal Module：engine/game/particles/libs/advancedProperty'; type Particle = import('!!Only Export Engine Module, Cant Use Internal Module：engine/game/particles/particle').default;
...
declare module '!!Only Export Engine Module, Cant Use Internal Module：engine/game/particles/particle' {
	...
	import { Entity2D, Entity3D } from '!!Only Export Engine Module, Cant Use Internal Module：engine/scene/scene';
	import MeshRenderer from '!!Only Export Engine Module, Cant Use Internal Module：engine/game/3D/meshRenderer';
	import { IParticleOffsetMap } from '!!Only Export Engine Module, Cant Use Internal Module：engine/game/particles/interface';
	import AdvancedPropertyClass from '!!Only Export Engine Module, Cant Use Internal Module：engine/game/particles/libs/advancedProperty';
...
declare module '!!Only Export Engine Module, Cant Use Internal Module：engine/game/3D/animator/AnimatorBlendTree' {
	...
	import AnimationClip from '!!Only Export Engine Module, Cant Use Internal Module：engine/assets/classes/animationClip'; class AnimatorBlendTree {
	    ...
	    type AnimatorBlendInfo = IBlend1D | IBlend2D | IBlendDirect;
...
declare module '!!Only Export Engine Module, Cant Use Internal Module：engine/assets/classes/animationClip' {
	...
	import { Kanata } from '!!Only Export Engine Module, Cant Use Internal Module：engine/globalContext';
	import { AnimationClipAsset, WrapMode } from '!!Only Export Engine Module, Cant Use Internal Module：engine/assets/resource';
	import { Nullable } from '!!Only Export Engine Module, Cant Use Internal Module：engine/type';
	import BaseResource from '!!Only Export Engine Module, Cant Use Internal Module：engine/assets/classes/baseResource';
	import AnimationEvent from '!!Only Export Engine Module, Cant Use Internal Module：engine/game/3D/animator/AnimationEvent';
...
declare module '!!Only Export Engine Module, Cant Use Internal Module：engine/render-graph/RenderGraph' {
	...
	export default class RenderGraph<IOptions = any> {
	    ...
	    showDebugInfo(callback?: (digraph: RenderGraph['_digraph'], sorted: TRGNodeAny[]) => void): string;
	}
	export {};
...
declare module '!!Only Export Engine Module, Cant Use Internal Module：engine/system/worker' {
	...
	import { Nullable } from '!!Only Export Engine Module, Cant Use Internal Module：engine/type';
	import { IGameSystem } from '!!Only Export Engine Module, Cant Use Internal Module：engine/game/game';
	import WorkerModule from '!!Only Export Engine Module, Cant Use Internal Module：engine/worker/module'; type Game = import('!!Only Export Engine Module, Cant Use Internal Module：engine/game/game').default;
	export enum Module {
	    LOGIC = 0,
	    WX_API = 1
	}
...
declare module '!!Only Export Engine Module, Cant Use Internal Module：engine/game/streaming-loading' {
	import Component from '!!Only Export Engine Module, Cant Use Internal Module：engine/game/component'; enum EUnloadType {
...
declare module '!!Only Export Engine Module, Cant Use Internal Module：engine/game/transform2D' {
	...
	import { Nullable } from '!!Only Export Engine Module, Cant Use Internal Module：engine/type';
	import TransformBase from '!!Only Export Engine Module, Cant Use Internal Module：engine/game/transformBase';
	import { M4ReadOnly, M3ReadOnly, V2ReadOnly } from '!!Only Export Engine Module, Cant Use Internal Module：engine/math/types';
...
declare module '!!Only Export Engine Module, Cant Use Internal Module：engine/assets/resource' {
	import { EBuiltinPostProcess } from '!!Only Export Engine Module, Cant Use Internal Module：engine/render-graph/buildinRGNodes/postProcessing';
	import { Kanata } from '!!Only Export Engine Module, Cant Use Internal Module：engine/globalContext';
	...
	export type SpecializedPPStep = IPPStepFXAA | IPPStepBlit | IPPStepHDR | IPPStepBloom;
...
declare module '!!Only Export Engine Module, Cant Use Internal Module：engine/game/3D/playableDirector/audio/audioPlayableAsset' {
	import { ClipCaps, TimelineClipAsset } from '!!Only Export Engine Module, Cant Use Internal Module：engine/assets/classes/playable/interface';
	import AudioClip from '!!Only Export Engine Module, Cant Use Internal Module：engine/assets/classes/audioClip';
	import { Nullable } from '!!Only Export Engine Module, Cant Use Internal Module：engine/type'; class AudioPlayableAsset extends TimelineClipAsset {
	    get clipCaps(): ClipCaps;
	    /**
	     * 该Clip所使用的audio资源。
	     *
...
declare module '!!Only Export Engine Module, Cant Use Internal Module：engine/game/3D/playableDirector/animation/animationTrack' {
	...
	import TrackAsset from '!!Only Export Engine Module, Cant Use Internal Module：engine/assets/classes/playable/trackAsset';
	import { Nullable } from '!!Only Export Engine Module, Cant Use Internal Module：engine/type';
	import AnimationClip from '!!Only Export Engine Module, Cant Use Internal Module：engine/assets/classes/animationClip'; class AnimationTrack extends TrackAsset {
	    matchTargetFields: {
	        PositionX: boolean;
	        PositionY: boolean;
	        PositionZ: boolean;
...
declare module '!!Only Export Engine Module, Cant Use Internal Module：engine/shared/serialize/resources/avatarMask' {
	 type AvatarMask = import('!!Only Export Engine Module, Cant Use Internal Module：engine/assets/classes/AvatarMask').default;
...
declare module '!!Only Export Engine Module, Cant Use Internal Module：engine/shared/serialize/resources/avatar' {
	 type Avatar = import('!!Only Export Engine Module, Cant Use Internal Module：engine/assets/classes/Avatar').default;
